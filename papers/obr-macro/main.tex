...
\medskip
\noindent\textbf{Current-vintage note (11 August 2026).} This abstract and the
tables below describe the preserved November 2025 study. The deployed emulator
is anchored to the \emph{March 2026} EFO, where the anchored GDP MAPE is 0.15
per cent and consumption 0.25 per cent, and free-running company profits are
79.8 per cent off. Section~\ref{sec:calibration} states the current figures in
full; the live values are the March 2026 set, and they are what the project
website reports.
\end{abstract}
