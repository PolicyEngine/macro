...
This rewrites the twelve `<svg class="vchart">` blocks in `validation/index.html`
...
| `svar-coverage` | Empirical 68/90% band coverage across 49 rolling origins, by horizon | `papers/boe-svar/figures/coverage_evaluation.json` (generated by `make_coverage.py`) |
