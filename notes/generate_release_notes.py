...
<body class="doc has-section-tabs">
<a class="skip-link" href="#top">Skip to main content</a>
<div class="grain" aria-hidden="true"></div>
<header class="nav">
  <a class="brand" href="/"><img class="brand-logo" src="/assets/policyengine-mark.svg" alt="" width="20" height="20" />PolicyEngine Macro</a>
  <nav class="nav-links" aria-label="Primary">
    <a class="nav-mobile" href="/">Home</a><a class="nav-mobile" href="/models/">Explore</a><a class="nav-mobile nav-start" href="/connect/">Start</a><a class="nav-mobile" href="/contact/">Contact</a>
  </nav>
</header>
<nav class="section-tabs" aria-label="Explore PolicyEngine Macro">
  <a href="/models/">Models</a><a href="/docs/">Compare</a><a href="/papers/">Papers</a><a href="/validation/">Validation</a><a href="/forecasts/">Forecasts</a><a href="/notes/" aria-current="page">Notes</a><a href="/economy/">Economy</a>
</nav>
<main id="top">
